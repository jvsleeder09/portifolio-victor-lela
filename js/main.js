...
function updateFooterStats() {
    ...
    footerStats.innerHTML = `
        <div class="github-stat">
            <div class="stat-number">${MY_PROJECTS.length + EDUCATIONAL_PROJECTS.length}</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 10. Inicializar seção educacional
    if (typeof initEducationalSection === 'function') {
        initEducationalSection();
    }
